                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="au-card-inner">
                                       <h2 class="title-5 m-b-35">KONFIRMASI AKUN</h2>
                                       <?php echo @$error; ?>
                                    <form method="post" action="<?= base_url('DataUser/cek_akun')?>">
                                        <table>
                                            <tr>
                                                <td width="200" height="50" >Username</td>
                                                <td><input class="form-control" type="text" name="username" maxlength="15" value="<?php echo $this->session->userdata('username'); ?>" readonly></td>
                                            </tr>
                                            <tr>
                                                <td width="200" height="50" >Password lama</td>
                                                <td><input class="form-control" type="password" name="password" maxlength="6" placeholder="password lama"></td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                <td>
